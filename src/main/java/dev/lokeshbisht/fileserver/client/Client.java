...
public class Client {
    ...
    private static void instructions() {
        ...
        System.out.println("  1. You can upload a student file on the server.");
        System.out.println("  2. You can fetch a student file from the server.");
        System.out.println("  3. You can delete a student file from the server.");
